...
@Component({
    ...
    <div class="form-container-card buildora-card">
      ...
      <div
        *ngIf="submitStatus() === 'success'"
        class="submission-state state-success"
        role="alert"
      >
      ...
      <div
        *ngIf="submitStatus() === 'error'"
        class="submission-state state-error mb-6"
        role="alert"
      >
      ...
      >
        ...
        <fieldset class="form-section">
          ...
          <div class="form-grid">
            ...
            <div
              class="form-group"
              [class.has-error]="isInvalid('companyName')"
            >
              <label for="companyName" class="form-label">
                {{ "form.companyName" | translate }}
            ...
            <div
              class="form-group"
              [class.has-error]="isInvalid('companyType')"
            >
              <label for="companyType" class="form-label">
                {{ "form.companyType" | translate }}
                <span class="required-star">*</span>
              </label>
              <select
                id="companyType"
              ...
              >
                <option value="" disabled selected>
                  {{ "form.companyTypePlaceholder" | translate }}
                </option>
                <option value="construction">
                  {{ "form.companyTypeOptions.construction" | translate }}
                </option>
                <option value="consultancy">
                  {{ "form.companyTypeOptions.consultancy" | translate }}
                </option>
                <option value="infrastructure">
                  {{ "form.companyTypeOptions.infrastructure" | translate }}
                </option>
                <option value="fitout">
                  {{ "form.companyTypeOptions.fitout" | translate }}
                </option>
                <option value="other">
                  {{ "form.companyTypeOptions.other" | translate }}
                </option>
              </select>
              <div
                *ngIf="isInvalid('companyType')"
            ...
            <div
              class="form-group"
              [class.has-error]="isInvalid('companySize')"
            >
              <label for="companySize" class="form-label">
                {{ "form.companySize" | translate }}
                <span class="required-star">*</span>
              </label>
              <select
                id="companySize"
              ...
              >
                <option value="" disabled selected>
                  {{ "form.companySizePlaceholder" | translate }}
                </option>
                <option value="tier1">
                  {{ "form.companySizeOptions.tier1" | translate }}
                </option>
                <option value="tier2">
                  {{ "form.companySizeOptions.tier2" | translate }}
                </option>
                <option value="tier3">
                  {{ "form.companySizeOptions.tier3" | translate }}
                </option>
                <option value="tier4">
                  {{ "form.companySizeOptions.tier4" | translate }}
                </option>
              </select>
              <div
                *ngIf="isInvalid('companySize')"
            ...
            <div class="form-group" [class.has-error]="isInvalid('taxNumber')">
              ...
              >
                <span
                  *ngIf="contactForm.get('taxNumber')?.hasError('required')"
                  >{{ "validation.required" | translate }}</span
                >
                <span
          ...
          <div class="form-group mt-5">
            ...
            <div class="file-upload-row">
              <label class="file-upload-btn" for="taxImage">
                {{
                  selectedTaxImage()
                    ? ("form.taxImageChange" | translate)
                    : ("form.taxImageChoose" | translate)
                }}
              </label>
              <input
                id="taxImage"
              ...
              <span class="file-upload-name">
                {{
                  selectedTaxImage()?.name ||
                    ("form.taxImageNoFile" | translate)
                }}
              </span>
              <button
        ...
        <fieldset class="form-section">
          ...
          <div class="form-grid">
            ...
            <div class="form-group" [class.has-error]="isInvalid('fullName')">
              ...
              >
                <span
                  *ngIf="contactForm.get('fullName')?.hasError('required')"
                  >{{ "validation.required" | translate }}</span
                >
                <span
        ...
        <fieldset class="form-section">
          ...
          <div
            ...
            [class.has-error]="isInvalid('activeProjects')"
          >
            ...
            <div class="checkbox-grid">
              ...
              >
                ...
                <span class="checkbox-label">{{
                  "form.goalsOptions." + goal.key | translate
                }}</span>
              </label>
            </div>
          </div>
          ...
          <div class="form-group" [class.has-error]="isInvalid('consent')">
            <label class="consent-checkbox-label">
              ...
              <span class="consent-text"
                >{{ "form.consent" | translate }}
                <span class="required-star">*</span></span
              >
            </label>
            <div
              *ngIf="isInvalid('consent')"
              id="consent-error"
              class="error-feedback mt-1"
              role="alert"
            >
  ...
  styles: [
    `
      ...
      .submit-action-row app-shiny-button {
        @media (max-width: 480px) {
          width: 100%;
        }
      }
...
export class ContactFormComponent implements OnInit {
  ...
  private static readonly ALLOWED_TAX_IMAGE_TYPES = [
    "image/jpeg",
    "image/png",
    "application/pdf",
  ];
  ...
  onSubmit(): void {
    ...
    const payload: CompanyApplication = {
      ...
      activeProjects: formVal.activeProjects
        ? Number(formVal.activeProjects)
        : undefined,
    ...
    this.appService
      .submitApplication(payload, this.selectedTaxImage())
      .subscribe({
